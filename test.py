...
label = CTkLabel(master=framemenu,text="047pegasus",font=("Roboto", 20), fg_color='#3E3E3E',text_color='White').pack(side=TOP,padx=0,pady=(25,25))

download_home=CTkImage(light_image=Image.open("home.png"),dark_image=Image.open("home.png"),size=(30,30))

homelabel = CTkButton(master=framemenu,text="Home",font=("Roboto" ,20), cursor='arrow', fg_color='#3E3E3E',hover_color='gray11',text_color='White',image=download_home).pack(side=TOP,padx=(0,20),pady=(110,10))

download_stat=CTkImage(light_image=Image.open("statistics.png"),dark_image=Image.open("statistics.png"),size=(30,30))

cpustatslabel = CTkButton(master=framemenu,text="Statistics",font=("Roboto", 20), cursor='arrow',fg_color='#3E3E3E',hover_color='gray11',text_color='White',image=download_stat).pack(side=TOP,padx=0,pady=(20,10))

download_cont=CTkImage(light_image=Image.open("box.png"),dark_image=Image.open("box.png"),size=(25,25))

contlabel = CTkButton(master=framemenu,text="Containers",font=("Roboto", 20), cursor='arrow',fg_color='#3E3E3E',hover_color='gray11',text_color='White',image=download_cont).pack(side=TOP,padx=0,pady=(20,10))
...
button = CTkButton(framemenu,text="Logout",font=("Roboto", 20), fg_color="#1D0042", width=140,height=40,corner_radius=10,command=fun).pack(side=BOTTOM,padx=0,pady=(100,20))
...
CTkLabel(can_def1,text="Container CPU Utilization",font=("Roboto Bold", 25), fg_color='#383E54',text_color='White').pack(side=BOTTOM,fill=BOTH,expand=True,padx=(40,40),pady=(150,100))
CTkLabel(can_def1,text="75%",font=("Roboto Bold", 25), fg_color='#383E54',text_color='White').pack(side=BOTTOM,padx=(50,40),pady=(185,0))
...
CTkLabel(can_def2,text="Container Memory Utilization \n (NVRAM)",font=("Roboto Bold", 25), fg_color='#383E54',text_color='White').pack(side=BOTTOM,fill=BOTH, expand=True,padx=(20,20),pady=(117,100))
CTkLabel(can_def2,text="65%",font=("Roboto Bold", 25), fg_color='#383E54',text_color='White').pack(side=BOTTOM,padx=(45,40),pady=(185,0))
...
CTkLabel(can_def3,text="Net CPU Utilization",font=("Roboto Bold", 25), fg_color='#383E54',text_color='White').pack(side=BOTTOM,fill=BOTH,expand=True,padx=(80,80),pady=(150,100))
CTkLabel(can_def3,text="70%",font=("Roboto Bold", 25), fg_color='#383E54',text_color='White').pack(side=BOTTOM,padx=(50,40),pady=(185,0))
